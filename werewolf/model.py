...
class Werewolf(Player):
    ...
    async def eliminate(self) -> tuple[str | None, "LmLog"]:
        ...
        #     prompt="Human input",
        #     raw_resp="",
        #     result={"remove": options[-1], "reasoning": "Human decision"},
        # )
...
class Seer(Player):
    ...
    async def unmask(self) -> tuple[str | None, LmLog]:
        ...
        #     prompt="Human input",
        #     raw_resp="",
        #     result={"investigate": options[-1], "reasoning": "Human decision"},
        # )
...
class Doctor(Player):
    ...
    async def save(self) -> tuple[str | None, LmLog]:
        ...
        #     prompt="Human input",
        #     raw_resp="",
        #     result={"protect": options[-1], "reasoning": "Human decision"},
        # )
